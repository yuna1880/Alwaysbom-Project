    ...
    <section class="contents" id="contents" tabindex="0">
        <div id="root" data-app="join">
            <header class="content_header is_fixed_header">
                ...
                <a href="#" class="page_back"><img src="<c:url value="/static/image/backimg.jpg"/>" width="24px;" height="24px;" style="margin: 15px 0px 0px 20px;" />
                    <span class="blind">이전 페이지</span>
                </a>
                <a href="#" class="page_home"><img src="<c:url value="/static/image/homeimg.jpg"/>" width="24px;" height="24px;" style="margin: 30px 0px 0px 20px;" />
