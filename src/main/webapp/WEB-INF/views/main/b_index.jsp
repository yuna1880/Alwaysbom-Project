                            ...
                            <div class="position-absolute end-0 top-0">
                                <div class="d-flex p-3">
                                    <select name="link" class="me-2" ${empty image.path ? "disabled" : ""}>
                                        ...
                                        <option value="/fclass" ${image.link eq "/fclass/classList" ? "selected" : ""}>클래스</option>
                                        <option value="/community" ${image.link eq "/community/event/eventlist" ? "selected" : ""}>커뮤니티</option>
                                    </select>
