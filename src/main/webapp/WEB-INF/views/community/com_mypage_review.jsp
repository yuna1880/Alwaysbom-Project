            ...
            <div class="col-12 h-100" id="contentPane">
                <div class="col-12 border-info d-flex justify-content-center p-4">
                    <div class="col-12">
                        ...
                        <div class="btn">
                            <button type="button" class="btn btn-warning col-6" onclick="location.href='/community/goFaq'">자주 묻는 질문</button>
                            <button type="button" class="btn btn-warning col-6" onclick="location.href='/question/create'">1:1 문의하기</button>
                        </div>
