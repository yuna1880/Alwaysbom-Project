...
<%--                </div>--%>
<%--                <div class="row g-3">--%>
<%--&lt;%&ndash;                    버튼 스타일의 체크박스 &ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="col-md-4 d-flex align-items-center">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <input type="checkbox" class="btn-check" id="freeDelivery" autocomplete="off">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <label class="btn btn px-4 py-2 me-2 btn-outline-dark me-2" for="freeDelivery">무료배송</label><br>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <input type="checkbox" class="btn-check" id="discount" autocomplete="on" onclick="checkDiscount()">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <label class="btn btn px-4 py-2 btn-outline-dark" for="discount">할인 적용하기</label><br>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
