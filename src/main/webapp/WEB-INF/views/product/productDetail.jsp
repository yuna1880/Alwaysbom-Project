    ...
    <form method="post">
        ...
        <nav id="bread-nav" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb mb-3">
                ...
                <li class="breadcrumb-item"><a href="/product">소품</a></li>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="thumbnails d-flex flex-column justify-content-start">
                <div class="mb-4">
                    <img src="${productVo.image1}" alt="대표 썸네일" class="col-12">
                </div>
                <div class="d-flex justify-content-between">
                    <img src="${productVo.image1}" alt="썸네일1" class="col-4 pe-2">
                    <c:if test="${not empty productVo.image2}">
                        <img src="${productVo.image2}" alt="썸네일2" class="col-4 ps-1 pe-1">
                    </c:if>
                    <c:if test="${not empty productVo.image3}">
                        <img src="${productVo.image3}" alt="썸네일3" class="col-4 ps-2">
                    </c:if>
                </div>
            </div>
            ...
            <div class="order-info d-flex flex-column">
                ...
                <div class="d-flex justify-content-center mt-5">
                    ...
                    <input type="hidden" name="flowerIdx" value="${productVo.idx}">
