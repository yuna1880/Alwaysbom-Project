...
<%--                                        <button type="button" class="btn btn-outline-secondary">찾기</button>--%>
                ...
                <tr>
                    <td>
                        <span class="detail"><span class="th">배송지 저장</span>
            ...
            <div>
                <div class="unknow_address">
                    <h4 class="tit">받는 분의 주소를 모르셔도 괜찮아요.<br>
                        kukka가 대신 여쭤볼게요 :-)</h4>
                    <div class="noti_txt">
                        <li class="color_red">기재해주신 연락처로 배송지를 입력할 수
                            있는 URL이 발송됩니다.</li>
                        <li class="color_red">입력 기간은 3일이며, 기한 내에
                            입력이 완료되지 않으면 주문은 취소됩니다.</li>
                        <li class="color_red">혹시 오류로 인해 문자가 가지 않는다면
                            [마이페이지-주문내역]에서 [다시 전송] 버튼을 눌러 주세요.</li>
                        <li class="color_red">받아보시는 분의 주소는 기존 배송지
                            목록에 추가되지 않습니다.</li>
                    </div>
                </div>
                <table class="address_input_table">
                    ...
                    <tr>
                        <td><span class="detail"><span class="th">수령인 이름</span>
                                <span class="td">
                                    <input maxlength="255" id="receiving_name_gift" name="receiving_name_gift" type="text"
                                           value="권유나" autocomplete="off">
                                </span>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td><span class="detail"><span class="th">수령인 연락처</span>
                                <span class="td_phone">
                                        <div><select id="receiving_phone1_gift"
                                                     name="receiving_phone1_gift">
                                                <option value="010">010</option>
                                                <option value="011">011</option>
                                                <option value="016">016</option>
                                                <option value="017">017</option>
                                                <option value="018">018</option>
                                                <option value="019">019</option>
                                            </select></div><span class="d">-</span>
                                        <div id="id_form-0-phone_2_form-group">
                                            <input type="text" maxlength="4" id="receiving_phone2_gift"
                                                   name="receiving_phone2_gift" value="5847" autocomplete="off">
                                        </div>
                                        <span class="d">-</span>
                                        <div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="closed-button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
