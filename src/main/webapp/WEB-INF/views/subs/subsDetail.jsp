    ...
    <form method="post">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="thumbnails d-flex flex-column justify-content-start">
                ...
                <div class="d-flex justify-content-between">
                    <img src="${subsVo.image1}" alt="썸네일1" class="col-4 pe-2">
                    <c:if test="${not empty subsVo.image2}">
                        <img src="${subsVo.image2}" alt="썸네일2" class="col-4 ps-1 pe-1">
                    </c:if>
                    <c:if test="${not empty subsVo.image3}">
                        <img src="${subsVo.image3}" alt="썸네일3" class="col-4 ps-2">
                    </c:if>
                </div>
            </div>
                ...
                <div class="inputs-wrap mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <select name="selectOptions" class="form-select p-2 ps-3" aria-label="form-select example">
                            ...
                            <option>1개월동안 X 2주마다</option>
                            <option>2개월동안 X 2주마다</option>
                            <option>6개월동안 X 2주마다</option>
                            <option>정기결제 (2주동안 자동결제)</option>
                        </select>
                        </div>
                    </div>
...
<%--                </div>--%>
                <div class="d-flex justify-content-end align-items-baseline me-2 mb-4">
                    ...
                    <fmt:formatNumber value="${subsVo.finalPrice + flowerVo.letterPrice}" pattern="#,###원"/>
                </span>
                </div>
                ...
                <div class="d-flex justify-content-center mt-5">
                    ...
                    <input type="hidden" name="flowerIdx" value="${subsVo.idx}">
