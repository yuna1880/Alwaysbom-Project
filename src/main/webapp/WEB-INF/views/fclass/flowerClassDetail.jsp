...
<%--    <nav id="bread-nav" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    ...
    <div class="d-flex justify-content-between thumb-order">
        ...
        <div class="thumbnails d-flex flex-column justify-content-start">
            <div class="mb-4">
                <img src="${fclassVo.image1}" alt="대표 썸네일" class="col-12">
            </div>
            <div class="d-flex">
                <img src="${fclassVo.image1}" alt="썸네일1" class="col-4 pe-3">
                <c:if test="${not empty fclassVo.image2}">
                <img src="${fclassVo.image2}" alt="썸네일2" class="col-4 ps-2 pe-2">
                </c:if>
                <c:if test="${not empty fclassVo.image3}">
                <img src="${fclassVo.image3}" alt="썸네일3" class="col-4 ps-3">
                </c:if>
            </div>
        </div>
...
<%--            <div class="fd-announcement d-flex justify-content-start py-3 my-4">
            ...
            <div class="inputs-wrap mb-4">
                <!-- 수업일 선택 옵션 -->
                <div class="row mb-4">
                    <div class="col-3 fw500 pt-1">수업일 선택</div>
                    <div class="col-9">
...
--%>
            ...
            <%--memberId, category, flowerIdx, quantity, letter 임의로 넣어주기--%>
                ...
                <button type="button" class="btn main-button fw-bold py-3" onclick="addCart(false, this.form)">클래스 예약하기</button>
            </div>
